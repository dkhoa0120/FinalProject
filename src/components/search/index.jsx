...
function SearchBar({ placeholder, data }) {
  ...
  return (
    ...
    <>
      <Button variant="outline-dark" onClick={handleShow}><i className="fa-solid fa-magnifying-glass" ></i></Button>
          ...
          <div className="search">
            <div className="searchInputs">
              ...
              {filteredData.length === 0 ? (
                ...
                <Button variant="outline-dark" onClick={clearInput}><i className="fa-solid fa-xmark"></i></Button>
              )}
                ...
                {filteredData.slice(0, 15).map((value, key) => {
                  return (
                    <React.Fragment key={value.id}>
                      <Nav.Link href={`/Manga/${value.id}`} className="dataItem">
                        <Image style={{ height: "60px", width: "40px" }} src={value.coverPath} />
