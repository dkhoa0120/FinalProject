    ...
    <>
      <div style={{ padding: "0 20px" }}>
        <div className="d-flex align-items-start">
          <div>
            ...
            <ul>
              ...
              <li>
                Any scanlated release is allowed to be uploaded regardless of
                the existence of official translations.
              </li>
              <li>
              ...
              <li>
                Uploading a chapter created by a tool that automatically edits
                and generates translated pages is not allowed. This includes
                tools that allow for additional manual editing after the
                automated process.
              </li>
        ...
        <ul>
          ...
          <ul>
            ...
            <li>
              ...
              or full proper translations as titles.
            </li>
            <li>
            ...
            <li>
              The language set for alternative titles should reflect the
              official or officially localised name for that language region
            </li>
          </ul>
        ...
        <ul>
          ...
          <li>
            When uploading a chapter, select all the groups that worked on it.
            If one of the groups does not exist on the site yet, create it
            first.
          </li>
          <li>
            If you want to upload a oneshot chapter, the chapter should be set
            to 0 and the category should be “Oneshot”.
          </li>
          <li>
            If you do not yet know who scanlated the chapter, do not upload it.
          </li>
          <li>
            If you are not part of the scanlation group, do not alter the
            release you are uploading by any means.
          </li>
        </ul>
      </div>
    </>
